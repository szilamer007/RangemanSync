This End User License Agreement ("Agreement") is a legal contract between you as an individual or business organisation ("you" or "Licensee") and RangemanSync app developer - Szilamer ("Licensor") for the RangemanSync for the Android software, including any associated media, printed materials and electronic documentation (the "Software").
...
Software is protected by Copyright Law and International Treaty provisions. Further, the structure, organization, and code embodied in Software are the valuable and confidential trade secrets of Licensor and its suppliers and are protected by intellectual property laws and treaties. Licensee agrees to abide by the copyright law and all other applicable laws.

# RESTRICTED USE DURING EVALUATION PERIOD

Subject to the terms of this Agreement, Licensee is granted a right to use Software for evaluation purposes without charge. This is a limited version where only the Download headers can be used from the date of installation of Software unless otherwise specified ("Evaluation Period").
...
Upon Licensee's decision, Licensee can obtain License Certificate for perpetual use of Software or cease using Software.

Software contains a feature that will automatically disable every button in the Software except "Download headers" while Software is used during Evaluation Period. Licensee may not disable, destroy, or remove this feature of Software, and any attempt to do so will be in violation of this Agreement and will terminate Licensee's rights to use Software.

# TYPES OF LICENSE

During the ordering process, you will be asked to select the type and quantity of license(s) you require:

(a)	A Device ID User License, which permits the Software to be used by one specific individual person who has a device with the calculated ID.
...
The Software is licensed to provide a synchronization of GPS coordinates between the Licensee's phone and Licensee's CASIO GPR-B1000 watch. It is intended for use by CASIO GPR-B1000 watch users, and all input and output of the software should be reviewed carefully by suitably experienced Casio watch user that are able to review, accept or reject any recommendations provided by the Software. For the avoidance of doubt you assume responsibility for the selection of the Software to achieve your intended results, and for the installation, use and results obtained from the Software.

# INSTALLATION OF THE SOFTWARE

If you purchase a Device ID based User License: You may install and use the Software only for your individual internal business or non-business purposes. 
...
The Licensee agrees for Licensor to periodically detect use of license key(s) as a part of anti-counterfeiting and license abuse measures.
...
A Device ID based User License is eligible for a free upgrade to any major or minor version of the Software released within 24 months of payment of the original license fee. As set out in this Clause 6, the Licensor has no obligation to provide updates or upgrades to the Software, or otherwise maintain or support the Software.
...
IN ANY CASE, LICENSOR'S ENTIRE LIABILITY UNDER ANY PROVISION OF THIS AGREEMENT WILL BE LIMITED TO THE 0.5 EUR AMOUNT.
...
The license fees are payable in accordance with the payment methods stipulated on the License as a Service Provider's website: https://netlicensing.io.
